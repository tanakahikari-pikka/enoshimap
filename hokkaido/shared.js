...
const missions = [
  ...
  // Row 2: 札幌市内定番 & すすきの入口
  { area: 'JOIN ALIVE',   spot: 'フェス会場ゲート', icon: '🎪', title: 'フェスに参戦',           mission: 'JOIN ALIVEの会場ゲートやフェス看板の前で、参戦記念のツーショット。',                               tip: '大通から直行バスで会場へ。日焼け対策と飲み物を忘れずに。', coords: [43.22640, 141.82670] },
  ...
  { area: 'JOIN ALIVE',   spot: 'ライブステージ',   icon: '🎸', title: 'ライブで盛り上がる',     mission: '開演前のステージや、フェスの熱気ある客席を背景に一枚。お目当てのアーティストを全力で楽しむ。',     tip: 'ステージ前は暑い。水分補給しながら。演奏中の撮影ルールは会場の案内に従って。', coords: [43.22700, 141.82750] },
