...
const missions = [
  ...
  { area: '札幌市内',     spot: '北海道庁旧本庁舎', icon: '🧱', title: '赤れんが庁舎',           mission: '赤れんが庁舎(または前庭)を背景に一枚。改修中でも記念に。',                                         tip: '正面の池と一緒に撮ると映える。',                         coords: [43.06420, 141.34690] },
  ...
  { area: '大通',         spot: '大通バスセンター', icon: '🚌', title: 'いざフェスへ',           mission: '大通バスセンターで、フェス会場行きのバスに乗り込む前の一枚。',                                     tip: '8:40くらい集合。飲み物と日焼け対策を忘れずに。',         coords: [43.06070, 141.35850] },
  { area: 'フェス',       spot: 'フェス会場',       icon: '🎪', title: 'フェスご飯',             mission: 'フェス会場のキッチンカー飯を、二人でシェアしている瞬間を撮る。',                                   tip: '昼はちょい時間をずらすと並ばず買える。',                 coords: [43.06060, 141.35550] },
  ...
  // Row 5: Day3 & 帰路
  { area: '札幌市内',     spot: '藻岩山展望台',     icon: '🌌', title: '藻岩山の夜景',           mission: '藻岩山山頂から、日本新三大夜景に数えられる札幌の夜景を二人で撮る。',                               tip: 'ロープウェイ+ミニケーブルカーで山頂へ。夕暮れ〜夜が◎。', coords: [43.02720, 141.32430] },
